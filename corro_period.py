...
SCRIPT_BUILD = "v3.2-summary-direct-strict-100-discount-2026-05-22"
...
def aggregate(orders, vmap, months, order_staff_map=None, shopifyql_staff_order_map=None):
    ...
    for order in orders:
        ...
        for li in line_items:
            ...
            # Exclude original $0 items and any order-level prorated fallback.
            if is_exact_100_discount:
...
def main():
    ...
    print(f"  ✓ Discount Zero validation: {len(disc_zero_rows)} rows are exact 100% line discounts")
