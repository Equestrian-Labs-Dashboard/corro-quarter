"""
CORRO PERIOD REPORT — v3.2-strict-discount-zero
==============================
...
def main():
    ...
    h_dz_det = ["updated_at","period","status","order_name","created_at","month","category",
                "customer_name","customer_email","tags","product_title","sku","vendor","product_type",
                "units","gross_sales","discount","discount_pct","exact_discount_pct","discount_source","discount_validation","net_paid","unit_cost","cogs",
